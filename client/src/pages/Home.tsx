...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* Hero Section */}
      <section className="relative flex items-center justify-center min-h-[85vh] overflow-hidden pt-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a href="https://wa.me/50622222222" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="gap-2 h-12 px-6 text-base font-semibold" data-testid="button-whatsapp-hero">
                  <SiWhatsapp className="w-5 h-5" />
                  Contáctenos
                </Button>
              </a>
              <a href="#servicios">
                <Button variant="outline" size="lg" className="h-12 px-6 text-base font-semibold" data-testid="button-services">
                  Nuestros Servicios
                </Button>
              </a>
            </div>
